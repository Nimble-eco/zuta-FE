...
const register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col py-5 bg-orange-700 mx-0">
        <ToastContainer />
        <div className="flex flex-col w-[90%] lg:w-[60%] mx-auto px-8 py-6 lg:border lg:border-gray-300 rounded-md align-middle my-auto !bg-white">
            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="w-[80%] lg:w-[60%] mx-auto h-14">
                    <ButtonFull
                        action="Submit"
                        loading={isLoading}
                        onClick={submit}
