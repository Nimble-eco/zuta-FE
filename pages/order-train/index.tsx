...
import { Search, TrendingUp, Percent, Train, Users, Clock, Tag, Sparkles, ChevronRight } from 'lucide-react';
...
const OrderTrainIndex = ({
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchStr.trim()) {
      router.push(`/order-train/result?search=${encodeURIComponent(searchStr)}&tab=top`);
    }
  };
